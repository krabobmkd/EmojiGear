...
static void buildMenuTemplate(const AppSettings *as)
{
    ...
    BAR(NM_ITEM);
    ADD(NM_ITEM,  NULL, 0, 0, 0, ACTION_UD(ACTION_FIND_NEXT));
    ADD(NM_ITEM,  NULL, 0, 0, 0, ACTION_UD(ACTION_FIND_PREVIOUS));
    BAR(NM_ITEM);
    ...
    ADD(NM_ITEM,  NULL, "P", 0, 0, ACTION_UD(ACTION_SETTINGS_WINDOW));
    ...
    ADD(NM_ITEM,  NULL, 0, CHECKIT|MENUTOGGLE, 0, ACTION_UD(ACTION_SETTINGS_ANSI_UNIX_COLORS));
