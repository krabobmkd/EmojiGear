...
;---------------------------------------------------------------------------
	...
	XREF _URPDC_AddFont
	XREF _URPDC_RemoveFont
	XREF _URPDC_FlushFonts
	XREF _URPDC_ChangeFontsSize

	XREF _URPDC_SetAttribsA

	XREF _URPDC_SetPreferenceFlags
	XREF _URPDC_GetPreferenceFlags
	XREF _URPDC_FlushGlyphCache
	XREF _URPDC_SetStyle

	XREF _URPDC_SetDrawColor
	XREF _URPDC_SetDrawColorFromPen

	XREF _URPDC_GetFontLineMetrics
	XREF _URPDC_TextSizeUTF8
	XREF _URPDC_HorizontalOffsetArrayUTF8

	XREF _URPDrawTextUTF8
...
RomTag:
        ...
        DC.B    0                       ; BYTE  RT_PRI
        DC.L    _Lib_ID    ; APTR  RT_NAME   libname is same as classid (myclass.class or myclass.gadget)
...
LibFuncTable:
	...
	DC.L	LibExpunge
	DC.L	0 ; LibReserved
	DC.L	_URPDC_Create		; 1st public function, for boospi classes, just return class pointer used by NewObject().
	DC.L	_URPDC_Retain
	DC.L	_URPDC_Release

	DC.L	_URPDC_AddFont
	DC.L	_URPDC_RemoveFont
	DC.L	_URPDC_FlushFonts
	DC.L	_URPDC_ChangeFontsSize

	DC.L	_URPDC_SetAttribsA

	DC.L	_URPDC_SetPreferenceFlags
	DC.L	_URPDC_GetPreferenceFlags
	DC.L	_URPDC_FlushGlyphCache
	DC.L	_URPDC_SetStyle

	DC.L	_URPDC_SetDrawColor
	DC.L	_URPDC_SetDrawColorFromPen

	DC.L	_URPDC_GetFontLineMetrics
	DC.L	_URPDC_TextSizeUTF8
	DC.L	_URPDC_HorizontalOffsetArrayUTF8

	DC.L	_URPDrawTextUTF8
...
_SysBase:
SysBase:	DC.L 0
	XDEF _CRunTimeInited
_CRunTimeInited: DC.L 0
...
DoExpunge:
		...
		move.l a5,a1
		CALL	Remove
    ; Close dependent libraries here
		move.l a5,a1
		moveq   #0,d0
