...
;---------------------------------------------------------------------------
	XREF _UniTextEditor_Init
	XREF _UniTextEditor_Exit
	XREF _UNITEXTEDITOR_GetClass
...
LibFuncTable:
	...
	DC.L	LibExpunge
	DC.L	0 ; LibReserved
	DC.L	_UNITEXTEDITOR_GetClass		; 1st public function, for boospi classes, just return class pointer used by NewObject().
...
;	bne.s	jp3			; if openers, don't remove class
	...
	;no need, done at CloseLibrary()  jsr	_CLibClose
;jp3:
...
DoExpunge:
		...
		; actually delete the class at expunge .
		jsr		_UniTextEditor_Exit
